...
############################## Evaluación Clustering KMeans - calculo WCSS (suma cuadrados internos) ###################################

# Calcular WCSS para valores de k del 1 al 5
wcss <- sapply(1:5, function(k) {
  kmeans(pab_statJug_ab_tris, centers = k, nstart = 25)$tot.withinss
})
